package com.benbenlaw.techopolis.events.loot;
...
public class MobAdditionModifier extends LootModifier {
    ...
    protected MobAdditionModifier(ILootCondition[] conditionsIn, Item addition) {
        super(conditionsIn);
    ...
    public static class Serializer extends GlobalLootModifierSerializer<MobAdditionModifier> {
        ...
        @Override
        public MobAdditionModifier read(ResourceLocation name, JsonObject object, ILootCondition[] conditionsIn) {
